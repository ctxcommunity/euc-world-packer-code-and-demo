...
source "vsphere-iso" "windows" {
  ...
  floppy_files            = ["config/Autounattend/${var.OStoInstall}-${var.vm-firmware}-core/autounattend.xml", "scripts/Install-vmtools.ps1","scripts/WinRM-Config.ps1", "scripts/Initial-Config.ps1", "config/JSON/${var.configpath}/server-config-${var.vm-name}.json"]
